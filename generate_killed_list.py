...
# Read raw data
raw_df = pd.read_csv('data/raw.csv', encoding="utf-8", keep_default_na=False)

# Read dict_ar_ar and dict_ar_en data
dict_ar_ar_df = pd.read_csv('data/dict_ar_ar.csv', encoding="utf-8", keep_default_na=False)
dict_ar_en_df = pd.read_csv('data/dict_ar_en.csv', encoding="utf-8", keep_default_na=False)
...
raw_df.to_csv('output/result.csv', index=False)
